package com.haste.lv.faith.ui.maintab.discovery;
...
public class ImageAnimator {
    ...
    private final TabDSCardAdapter mAdapter; // 适配器
    ...
    public ImageAnimator(TabDSCardAdapter adapter, ImageView targetImage, ImageView outgoingImage) {
        mAdapter = adapter;
