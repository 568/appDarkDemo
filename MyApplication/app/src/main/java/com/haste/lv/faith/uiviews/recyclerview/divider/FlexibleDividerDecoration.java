...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent instanceof PullToRefreshRecyclerView) {//如果是XRecyclerView需要特殊处理，XRecyclerView支持添加头和尾
            PullToRefreshRecyclerView xRecyclerView = ((PullToRefreshRecyclerView) parent);
