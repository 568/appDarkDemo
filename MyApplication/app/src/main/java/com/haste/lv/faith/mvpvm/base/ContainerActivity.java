 ...
 */
public class ContainerActivity extends BaseAbsLifecycleActivity {
    ...
    protected void initFromIntent(Intent data) {
        ...
        try {
            ...
            BaseLazyRxFragment fragment = (BaseLazyRxFragment) fragmentClass.newInstance();
    ...
    public void onBackPressed() {
        ...
        if (fragment instanceof BaseAbsLifecycleFragment) {
            if (!((BaseAbsLifecycleFragment) fragment).isBackPressed()) {
                super.onBackPressed();
            }
        } else {
            super.onBackPressed();
