package com.haste.lv.faith.ui.helper;
 ...
 * <p>
 * 使用ViewOffsetHelper工具类封装View的偏移量。
 * View类支持对offset进行偏移，但是并不会保存偏移量。
 * ViewOffsetHelper对Offset和Top/Left进行缓存，使用ViewCompat工具类进行偏移处理。
 */
