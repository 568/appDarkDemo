package com.haste.lv.faith.uiviews.tablayout;
...
import com.haste.lv.faith.uiviews.tablayout.util.FragmentChangeManager;
import com.haste.lv.faith.uiviews.tablayout.util.UnreadMsgUtils;
import com.haste.lv.faith.uiviews.tablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColor = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#3cd3db" : "#ffffff"));
        mIndicatorHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_height,
                DisplayUtil.dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 4 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
        mIndicatorWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_width, DisplayUtil.dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_corner_radius, DisplayUtil.dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_left, DisplayUtil.dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_top, DisplayUtil.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_right, DisplayUtil.dp2px(0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_bottom, DisplayUtil.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mUnderlineHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_underline_height, DisplayUtil.dp2px(0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_width, DisplayUtil.dp2px(0));
        mDividerPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_padding, DisplayUtil.dp2px(12));

        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, DisplayUtil.sp2px(13f));
        ...
        mIconWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_iconWidth, DisplayUtil.dp2px(0));
        mIconHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_iconHeight, DisplayUtil.dp2px(0));
        mIconMargin = ta.getDimension(R.styleable.CommonTabLayout_tl_iconMargin, DisplayUtil.dp2px(2.5f));

        mTabSpaceEqual = ta.getBoolean(R.styleable.CommonTabLayout_tl_tab_space_equal, true);
        mTabWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_width, DisplayUtil.dp2px(-1));
        mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? DisplayUtil.dp2px(0) : DisplayUtil.dp2px(10));
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setTabPadding(float tabPadding) {
        this.mTabPadding = DisplayUtil.dp2px(tabPadding);
        updateTabStyles();
    }
    ...
    public void setTabWidth(float tabWidth) {
        this.mTabWidth = DisplayUtil.dp2px(tabWidth);
        updateTabStyles();
    }
    ...
    public void setIndicatorHeight(float indicatorHeight) {
        this.mIndicatorHeight = DisplayUtil.dp2px(indicatorHeight);
        invalidate();
    }

    public void setIndicatorWidth(float indicatorWidth) {
        this.mIndicatorWidth = DisplayUtil.dp2px(indicatorWidth);
        invalidate();
    }

    public void setIndicatorCornerRadius(float indicatorCornerRadius) {
        this.mIndicatorCornerRadius = DisplayUtil.dp2px(indicatorCornerRadius);
        invalidate();
    }
    ...
    public void setIndicatorMargin(float indicatorMarginLeft, float indicatorMarginTop,
        ...
        this.mIndicatorMarginLeft = DisplayUtil.dp2px(indicatorMarginLeft);
        this.mIndicatorMarginTop = DisplayUtil.dp2px(indicatorMarginTop);
        this.mIndicatorMarginRight = DisplayUtil.dp2px(indicatorMarginRight);
        this.mIndicatorMarginBottom = DisplayUtil.dp2px(indicatorMarginBottom);
        invalidate();
    }
    ...
    public void setUnderlineHeight(float underlineHeight) {
        this.mUnderlineHeight = DisplayUtil.dp2px(underlineHeight);
        invalidate();
    }
    ...
    public void setDividerWidth(float dividerWidth) {
        this.mDividerWidth = DisplayUtil.dp2px(dividerWidth);
        invalidate();
    }

    public void setDividerPadding(float dividerPadding) {
        this.mDividerPadding = DisplayUtil.dp2px(dividerPadding);
        invalidate();
    }

    public void setTextsize(float textsize) {
        this.mTextsize = DisplayUtil.sp2px(textsize);
        updateTabStyles();
    }
    ...
    public void setIconWidth(float iconWidth) {
        this.mIconWidth = DisplayUtil.dp2px(iconWidth);
        updateTabStyles();
    }

    public void setIconHeight(float iconHeight) {
        this.mIconHeight = DisplayUtil.dp2px(iconHeight);
        updateTabStyles();
    }

    public void setIconMargin(float iconMargin) {
        this.mIconMargin = DisplayUtil.dp2px(iconMargin);
        updateTabStyles();
    }
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mIconGravity == Gravity.TOP || mIconGravity == Gravity.BOTTOM) {
                lp.leftMargin = DisplayUtil.dp2px(leftPadding);
                lp.topMargin = mHeight > 0 ? (int) (mHeight - textHeight - iconH - margin) / 2 - DisplayUtil.dp2px(bottomPadding) : DisplayUtil.dp2px(bottomPadding);
            } else {
                lp.leftMargin = DisplayUtil.dp2px(leftPadding);
                lp.topMargin = mHeight > 0 ? (int) (mHeight - Math.max(textHeight, iconH)) / 2 - DisplayUtil.dp2px(bottomPadding) : DisplayUtil.dp2px(bottomPadding);
            }
