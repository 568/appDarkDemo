 ...
 * 提供分组便捷操作,可设置状态的错误页面、空页面、加载中页面、内容页面自由切换
 */

public abstract class SectionStateRecyclerViewAdapter<T> extends SectionRecyclerViewAdapter<T>{
    ...
    public SectionStateRecyclerViewAdapter(Context context, List list) {
        super(context, list);
    }

    public SectionStateRecyclerViewAdapter(Context context) {
        super(context);
    }
