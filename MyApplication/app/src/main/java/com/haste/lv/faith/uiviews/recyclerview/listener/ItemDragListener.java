...
import com.haste.lv.faith.uiviews.recyclerview.adapter.HelperRecyclerViewDragAdapter;
...
public class ItemDragListener extends ItemTouchHelper.Callback {
    ...
    private boolean isViewCreateByAdapter(RecyclerView.ViewHolder viewHolder) {
        ...
        return type == PullToRefreshRecyclerView.TYPE_REFRESH_HEADER || type == PullToRefreshRecyclerView.TYPE_LOADMORE_FOOTER;
