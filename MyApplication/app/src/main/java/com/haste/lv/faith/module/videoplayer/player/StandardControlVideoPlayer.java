 ...
 * 1.画面显示比例 默认 4:3 16:9 拉伸
 * 2.旋转画面， 90度的旋转方式
 * 3.旋转镜头 上下镜头， 左右镜头
 */

public class StandardControlVideoPlayer extends StandardGSYVideoPlayer {
     ...
     * 如果需要不同布局区分功能，需要重载
     */
    public StandardControlVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public StandardControlVideoPlayer(Context context) {
        super(context);
    }

    public StandardControlVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.switch_video_standard_control_layout;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        StandardControlVideoPlayer sampleVideo = (StandardControlVideoPlayer) super.startWindowFullscreen(context, actionBar, statusBar);
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            StandardControlVideoPlayer sampleVideo = (StandardControlVideoPlayer) gsyVideoPlayer;
