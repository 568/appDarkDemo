...
import com.haste.lv.faith.uiviews.recyclerview.listener.OnItemDragListener;
 ...
 * 继承于HelperRecyclerViewAdapter提供拖拽便捷操作的baseDragAdapter
 */
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled) {
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                View toggleView = ((CommonRecyclerViewHolder) holder).getView(mToggleViewId);
                if (toggleView != null) {
