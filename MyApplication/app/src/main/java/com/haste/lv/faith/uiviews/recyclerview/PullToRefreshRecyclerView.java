package com.haste.lv.faith.uiviews.recyclerview;
...
import com.haste.lv.faith.uiviews.recyclerview.adapter.BaseRecyclerViewHolder;
import com.haste.lv.faith.uiviews.recyclerview.listener.AppBarStateChangeListener;
import com.haste.lv.faith.uiviews.recyclerview.refresh.ArrowRefreshHeader;
import com.haste.lv.faith.uiviews.recyclerview.refresh.IMoreFooter;
import com.haste.lv.faith.uiviews.recyclerview.refresh.IRefreshHeader;
import com.haste.lv.faith.uiviews.recyclerview.refresh.LoadingMoreFooter;
 ...
 * <p>描述:自定义带有刷新控制的PullToRefreshRecyclerView<br/></p>
 * <p>
...
//            int head_foot_items_Count = layoutManager.getItemCount();
    ...
    public class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private class SimpleViewHolder extends BaseRecyclerViewHolder {
